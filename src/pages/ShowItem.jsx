  ...
  return (
    <>
      {item.current.map((item) => (
        <div
          key={item.id}
          className='w-11/12 md:w-3/4 mx-auto my-3 shadow-md border dark:border-[#272727]'>
          <img src={item.src} alt={item.name} className='mb-5 mx-auto' />
          <div className='block md:flex'>
            <div className='w-100 md:w-1/2 border p-2 md:mx-2 m-2 dark:border-[#272727]'>
            ...
            <div className='w-100 md:w-1/2 p-5 border md:mx-2 m-2 dark:border-[#272727]'>
